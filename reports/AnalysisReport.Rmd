...
# Ensuring the correct file path and use read_csv to load the files
X3_video_stats <- read_csv("H:/work 1/data/cyber-security-3_video-stats.csv")
X4_video_stats <- read_csv("H:/work 1/data/cyber-security-4_video-stats.csv")
X5_video_stats <- read_csv("H:/work 1/data/cyber-security-5_video-stats.csv")
X6_video_stats <- read_csv("H:/work 1/data/cyber-security-6_video-stats.csv")
X7_video_stats <- read_csv("H:/work 1/data/cyber-security-7_video-stats.csv")
